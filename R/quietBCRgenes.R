...
#'   - A Seurat object
#'   - A vector of variable genes generated by workflows such as Bioconductor's `scran`
#' @param assay Character. Specifies the Seurat assay slot to use for removing BCR genes.
#'   If `NULL`, the function defaults to the active assay in the Seurat object.
#' 
...
#' variable gene list in the [quietBCRgenes()] function.
#'
